// ============================================================
// MEGA TOOLS — REDIRECT ROUTES (ENTERPRISE v6.1: Real UA capture)
// v6.1: User Agent — Real capture from request header
// ============================================================
...
router.post('/', async (req, res) => {
  try {
    ...
    // v6.1: Real User Agent capture from request header
