...
const CONFIG = {
  ...
  // ---- SESSION TIMINGS ----
  SESSION_TIMEOUT_MS: parseInt(process.env.SESSION_TIMEOUT_MS) || 300000,
  HEARTBEAT_INTERVAL_MS: parseInt(process.env.HEARTBEAT_INTERVAL_MS) || 30000,
  AWAY_THRESHOLD_MS: parseInt(process.env.AWAY_THRESHOLD_MS) || 30000,
  AUTO_TRASH_INTERVAL_MS: parseInt(process.env.AUTO_TRASH_INTERVAL_MS) || 900000,
  INBOX_CLEAN_INTERVAL_MS: parseInt(process.env.INBOX_CLEAN_INTERVAL_MS) || 86400000,
  TRASH_MAX_AGE_DAYS: parseInt(process.env.TRASH_MAX_AGE_DAYS) || 30,
...
// ---- COMPUTED ----
CONFIG.TRASH_MAX_AGE_MS = CONFIG.TRASH_MAX_AGE_DAYS * 24 * 60 * 60 * 1000;
