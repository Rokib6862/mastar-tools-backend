// ============================================================
// MEGA TOOLS — SMART REDIRECT ENGINE (Universal Runtime) v2.0
// Production Hardened
// ============================================================
...
function generateSmartRedirectScript(req) {
  const serverUrl = CONFIG.IS_PRODUCTION
    ? (CONFIG.CLIENT_URL || 'https://mega-tools.online')
    : 'http://localhost:' + CONFIG.PORT;

  const safeServerUrl = escapeJsString(serverUrl);

  return `// ============================================================
// MEGA TOOLS — Smart Redirect Engine v2.0
...
//   <script src="${safeServerUrl}/mega-redirect.js"></script>
// ============================================================
(function(){
  "use strict";

  // ========== CONFIG ==========
  var API = "${safeServerUrl}";
